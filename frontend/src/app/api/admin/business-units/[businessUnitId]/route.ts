...
export async function PATCH(
  ...
  try {
    ...
    const updated = await fetchBackend(`/admin/business-units/${businessUnitId}`, {
      method: "PATCH",
    ...
    return NextResponse.json({ detail: "Nao foi possivel atualizar a unidade de negocio." }, { status: 500 });
  }
}
